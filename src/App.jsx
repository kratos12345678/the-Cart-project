    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/mens"
            element={<ShopCategary banner={men_banner} categary="mens" />}
          />

          <Route
            path="/womens"
            element={<ShopCategary banner={women_banner} categary="womens" />}
          />

          <Route
            path="/kids"
            element={<ShopCategary banner={kids_banner} categary="kids" />}
          />
